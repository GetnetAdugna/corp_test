...
//                     <h2 className="current-song-title">{`Current Song: ${currentSong?.id}`}</h2>
//                     Create song with file:
//                     <input className="file-input" type="file" onChange={createSongWithImage} />
//                 </label>
//                 <label className="song-label">
...
//                 </button>
//                 <button className="action-button" onClick={deleteCurrentSongAndImage} disabled={!currentSong}>
