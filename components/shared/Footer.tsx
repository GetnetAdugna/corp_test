...
export default function Footer({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-full flex flex-col md:flex-row justify-between gap-6 mt-2 px-6 py-3 max-w-full container-wide">
          <div className="w-full flex flex-col gap-4 md:max-w-xs lg:max-w-sm">
            <Link href="/" aria-label={siteConfig.title}>
              <div className="flex items-center gap-3 justify-start">
                <Image
                  src="/static/images/logo.webp"
                  alt="Niche AI Services logo"
                  height={32}
                  width={32}
      ...
      <div>
        <hr
          className="w-full border-0 bg-gradient-to-r from-white/5 via-black/10 to-white/5 dark:from-black/5 dark:via-white/30 darK:to-black/5"
          style={{ height: '1px' }}
        />
        ...
        <div className="px-2 flex flex-col items-center">
          ...
          <div className="w-full text-center p-2 space-x-2 text-sm text-gray-500 dark:text-gray-400">            <span>{siteConfig.author}</span>
            <span>{` • `}</span>
